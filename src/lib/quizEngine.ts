    ...
    const levels: SiraLevel[] = [
        {
            ...
            questions: [
                ...
                buildMCQ('stories', 'Quel était le nom de la nourrice du Prophète ﷺ ?', 'Halima Saadiya', ['Amina', 'Barakah', 'Khadija'])!,
                buildMCQ('stories', 'Quel âge avait le Prophète ﷺ à la mort de sa mère ?', '6 ans', ['4 ans', '8 ans', '10 ans'])!,
                buildMCQ('stories', 'Comment s\'appelait le père du Prophète ﷺ ?', 'Abdullah', ['Abdul-Muttalib', 'Abu Talib', 'Hamza'])!,
                buildMCQ('stories', 'Qui était le grand-père du Prophète ﷺ ?', 'Abdul-Muttalib', ['Hashim', 'Qusai', 'Kilab'])!,
                buildMCQ('stories', 'Dans quel clan de Quraysh est né le Prophète ﷺ ?', 'Banu Hashim', ['Banu Makhzum', 'Banu Umayya', 'Banu Zuhrah'])!,
                buildMCQ('stories', 'Quel surnom a été donné au Prophète ﷺ pour son honnêteté ?', 'Al-Amin', ['As-Siddiq', 'Al-Faruq', 'An-Nasir'])!,
                buildMCQ('stories', 'Quel métier le Prophète ﷺ a-t-il exercé dans sa jeunesse ?', 'Berger puis commerçant', ['Forgeron', 'Agriculteur', 'Tisserand'])!,
            ],
        ...
        },
        {
            ...
            questions: [
                ...
                buildMCQ('stories', 'Sur quelle montagne se trouve la grotte de Hira ?', 'Jabal an-Nur', ['Jabal Uhud', 'Jabal Thawr', 'Jabal Arafat'])!,
                buildMCQ('stories', 'Quel âge avait le Prophète ﷺ lors de la première révélation ?', '40 ans', ['25 ans', '33 ans', '45 ans'])!,
                buildMCQ('stories', 'Qui était la première personne à croire au message du Prophète ﷺ ?', 'Khadija bint Khuwaylid', ['Abu Bakr', 'Ali ibn Abi Talib', 'Zaid ibn Harithah'])!,
                buildMCQ('stories', 'Comment s\'appelait le cousin de Khadija qui a confirmé la prophétie ?', 'Waraqa ibn Nawfal', ['Abu Sufyan', 'Abu Lahab', 'Abbas'])!,
                buildMCQ('stories', 'Pendant combien d\'années la prédication est-elle restée secrète ?', '3 ans', ['1 an', '5 ans', '10 ans'])!,
                buildMCQ('stories', 'Quel était le premier lieu de rassemblement secret des musulmans ?', 'Maison d\'Al-Arqam', ['Kaaba', 'Mosquée de Quba', 'Maison d\'Abu Bakr'])!,
                buildMCQ('stories', 'Quelle était la réaction initiale de Quraysh face à la prédication publique ?', 'Moquerie et hostilité', ['Indifférence', 'Acceptation immédiate', 'Soutien financier'])!,
            ],
        ...
        },
        {
            ...
            questions: [
                ...
                buildMCQ('stories', 'Qui a dormi dans le lit du Prophète ﷺ pour tromper les assassins ?', 'Ali ibn Abi Talib', ['Abu Bakr', 'Zaid', 'Hamza'])!,
                buildMCQ('stories', 'Quelle était la récompense offerte par Quraysh pour la capture du Prophète ﷺ ?', '100 chamelles', ['50 chamelles', '1000 pièces d\'or', 'La royauté'])!,
                buildMCQ('stories', 'Qui est le cavalier qui a tenté de capturer le Prophète ﷺ mais dont le cheval s\'est enfoncé dans le sable ?', 'Suraqa ibn Malik', ['Abu Jahl', 'Khalid ibn al-Walid', 'Ikrimah'])!,
                buildMCQ('stories', 'Quelle est la première mosquée construite par le Prophète ﷺ lors de son arrivée ?', 'Mosquée de Quba', ['Masjid an-Nabawi', 'Masjid al-Haram', 'Masjid al-Aqsa'])!,
                buildMCQ('stories', 'Comment ont été appelés les habitants de Médine qui ont accueilli les migrants ?', 'Les Ansar (Auxiliaires)', ['Les Muhajirun', 'Les Quraichites', 'Les Omeyyades'])!,
                buildMCQ('stories', 'Comment s\'appelait la chamelle du Prophète ﷺ ?', 'Al-Qaswa', ['Al-Adba', 'Al-Jawa', 'Al-Buraq'])!,
                buildMCQ('stories', 'En quelle année du calendrier grégorien a eu lieu l\'Hégire ?', '622', ['610', '632', '570'])!,
            ],
            unlocked: false, completed: false, stars: 0,
        },
        {
            id: 'sira_4',
            order: 4,
            title: 'Le Grand Jour du Discernement',
            titleAr: 'غزوة بدر',
            description: 'La première grande bataille victorieuse à Badr.',
            location: 'Puits de Badr',
            year: '624 ap. J-C (2 AH)',
            questions: [
                buildMCQ('stories', 'En quelle année a eu lieu la bataille de Badr ?', '2 AH', ['1 AH', '3 AH', '5 AH'])!,
                buildMCQ('stories', 'Combien de musulmans étaient présents à Badr ?', '313', ['1000', '700', '1500'])!,
                buildMCQ('stories', 'Quel était le chef de l\'armée de Quraysh à Badr ?', 'Abu Jahl', ['Abu Sufyan', 'Abu Lahab', 'Utba'])!,
                buildMCQ('stories', 'Comment le Coran appelle-t-il le jour de Badr ?', 'Yawm al-Furqan', ['Yawm al-Fath', 'Yawm al-Ahzab', 'Yawm al-Qiyamah'])!,
                buildMCQ('stories', 'Combien de musulmans sont tombés martyrs à Badr ?', '14', ['70', '10', '40'])!,
                buildMCQ('stories', 'Quel célèbre oncle du Prophète ﷺ a combattu à Badr ?', 'Hamza ibn Abdul-Muttalib', ['Abbas', 'Abu Talib', 'Abu Lahab'])!,
                buildMCQ('stories', 'Quel était l\'objectif initial des musulmans avant la bataille ?', 'Intercepter une caravane', ['Conquérir un château', 'Aller à la Mecque', 'Chercher de l\'eau'])!,
                buildMCQ('stories', 'Qui portait la bannière des Muhajirun à Badr ?', 'Mus\'ab ibn Umayr', ['Ali', 'Omar', 'Uthman'])!,
                buildMCQ('stories', 'Quelle aide divine est mentionnée dans le Coran pour Badr ?', 'Une armée d\'anges', ['Une tempête de feu', 'Un tremblement de terre', 'Une inondation'])!,
                buildMCQ('stories', 'Quel ennemi juré a été tué par deux jeunes garçons Ansar ?', 'Abu Jahl', ['Abu Sufyan', 'Umaya ibn Khalaf', 'Walid ibn Mughira'])!,
            ],
            unlocked: false, completed: false, stars: 0,
        },
        {
            id: 'sira_5',
            order: 5,
            title: 'L\'Épreuve d\'Uhud',
            titleAr: 'غزوة أحد',
            description: 'La bataille d\'Uhud et les leçons de l\'obéissance.',
            location: 'Mont Uhud',
            year: '625 ap. J-C (3 AH)',
            questions: [
                buildMCQ('stories', 'En quelle année a eu lieu la bataille d\'Uhud ?', '3 AH', ['2 AH', '4 AH', '6 AH'])!,
                buildMCQ('stories', 'Quel célèbre martyr est appelé "Le Lion d\'Allah" ?', 'Hamza ibn Abdul-Muttalib', ['Ali ibn Abi Talib', 'Khalid ibn al-Walid', 'Jafar ibn Abi Talib'])!,
                buildMCQ('stories', 'Pourquoi l\'avantage a-t-il tourné en faveur des mecquois ?', 'Les archers ont quitté leur poste', ['Le Prophète est mort', 'La cavalerie a fui', 'Il n\'y avait plus d\'eau'])!,
                buildMCQ('stories', 'Qui a tué Hamza (l\'oncle du Prophète) ?', 'Wahshi', ['Abu Sufyan', 'Hind', 'Khalid'])!,
                buildMCQ('stories', 'Combien de musulmans sont tombés martyrs à Uhud ?', '70', ['14', '100', '40'])!,
                buildMCQ('stories', 'Quel compagnon a protégé le Prophète ﷺ de son propre corps ?', 'Abu Dujana', ['Abu Bakr', 'Omar', 'Uthman'])!,
                buildMCQ('stories', 'Qui commandait la cavalerie mecquoise à l\'époque ?', 'Khalid ibn al-Walid', ['Abu Sufyan', 'Abu Jahl', 'Ikrimah'])!,
                buildMCQ('stories', 'Qu\'est-il arrivé au Prophète ﷺ durant la bataille ?', 'Il a été blessé au visage', ['Il a été capturé', 'Il a perdu son épée', 'Il a été épargné par miracle'])!,
                buildMCQ('stories', 'Quel nom porte la colline où se trouvaient les archers ?', 'Jabal al-Rumat', ['Jabal Uhud', 'Jabal Hira', 'Jabal Thawr'])!,
                buildMCQ('stories', 'Qui a propagé la rumeur de la mort du Prophète ﷺ ?', 'Ibn Qami\'a', ['Abu Sufyan', 'Wahshi', 'Abu Jahl'])!,
            ],
            unlocked: false, completed: false, stars: 0,
        },
        {
            id: 'sira_6',
            order: 6,
            title: 'Le Siège des Alliés',
            titleAr: 'غزوة الخندق',
            description: 'La bataille de la Tranchée et la défense de Médine.',
            location: 'Médine',
            year: '627 ap. J-C (5 AH)',
            questions: [
                buildMCQ('stories', 'Quel compagnon a suggéré de creuser une tranchée ?', 'Salman al-Farisi', ['Abu Bakr', 'Bilal', 'Ali'])!,
                buildMCQ('stories', 'Pourquoi cette bataille s\'appelle-t-elle aussi Bataille des Coalisés (Al-Ahzab) ?', 'Plusieurs tribus se sont alliées', ['Deux armées se sont unies', 'C\'était une guerre civile', 'Les anges se sont alliés'])!,
                buildMCQ('stories', 'Combien d\'hommes l\'armée des coalisés comptait-elle environ ?', '10 000', ['3 000', '5 000', '20 000'])!,
                buildMCQ('stories', 'Quelle tribu juive a rompu son pacte durant le siège ?', 'Banu Qurayza', ['Banu Nadir', 'Banu Qaynuqa', 'Banu Khaybar'])!,
                buildMCQ('stories', 'Comment le siège a-t-il pris fin ?', 'Un vent violent et froid', ['Une pluie de feu', 'Une attaque surprise', 'Une négociation de paix'])!,
                buildMCQ('stories', 'Combien de temps a duré le siège de Médine ?', 'Environ 1 mois', ['1 semaine', '3 mois', '10 jours'])!,
                buildMCQ('stories', 'Quel guerrier célèbre a traversé la tranchée pour un duel ?', 'Amr ibn Abd Wudd', ['Abu Sufyan', 'Khalid ibn al-Walid', 'Ikrimah'])!,
                buildMCQ('stories', 'Qui a remporté le duel contre Amr ibn Abd Wudd ?', 'Ali ibn Abi Talib', ['Hamza', 'Omar', 'Zubayr'])!,
                buildMCQ('stories', 'Quel compagnon a semé la discorde entre les coalisés ?', 'Nu\'aym ibn Mas\'ud', ['Abu Bakr', 'Ali', 'Zaid'])!,
                buildMCQ('stories', 'Quelle sourate du Coran porte le nom de cette bataille ?', 'Al-Ahzab', ['Al-Anfal', 'Al-Baqara', 'At-Tawba'])!,
            ],
            unlocked: false, completed: false, stars: 0,
        },
        {
            id: 'sira_7',
            order: 7,
            title: 'Le Pacte de la Paix',
            titleAr: 'صلح الحديبية',
            description: 'Le traité d\'Al-Hudaybiya et la victoire éclatante.',
            location: 'Al-Hudaybiya',
            year: '628 ap. J-C (6 AH)',
            questions: [
                buildMCQ('stories', 'Pourquoi les musulmans se rendaient-ils à la Mecque ?', 'Pour faire la Omra', ['Pour faire la guerre', 'Pour le commerce', 'Pour le Hajj'])!,
                buildMCQ('stories', 'Quel est le nom du pacte signé avec Quraysh ?', 'Le traité d\'Al-Hudaybiya', ['Le pacte de Médine', 'Le traité de Taif', 'Le serment d\'allégeance'])!,
                buildMCQ('stories', 'Quel compagnon a été envoyé comme émissaire à la Mecque ?', 'Uthman ibn Affan', ['Omar ibn al-Khattab', 'Ali ibn Abi Talib', 'Zaid ibn Harithah'])!,
                buildMCQ('stories', 'Comment s\'appelle le serment prêté sous l\'arbre ?', 'Bay\'at al-Ridwan', ['Bay\'at al-Aqaba', 'Bay\'at al-Fath', 'Bay\'at al-Islam'])!,
                buildMCQ('stories', 'Combien d\'années de paix le traité prévoyait-il ?', '10 ans', ['5 ans', '1 an', '20 ans'])!,
                buildMCQ('stories', 'Quelle sourate a été révélée après le traité, l\'appelant "une victoire éclatante" ?', 'Al-Fath', ['Al-Nasr', 'Al-Anfal', 'Al-Maidah'])!,
                buildMCQ('stories', 'Qui a représenté Quraysh pour la signature du traité ?', 'Suhayl ibn Amr', ['Abu Sufyan', 'Khalid ibn al-Walid', 'Abu Jahl'])!,
                buildMCQ('stories', 'Quelle clause du traité paraissait injuste aux musulmans ?', 'Renvoyer ceux qui fuient la Mecque', ['L\'arrêt de la prière', 'Le paiement d\'un tribut', 'L\'interdiction de prêcher'])!,
                buildMCQ('stories', 'Quand les musulmans ont-ils pu faire leur Omra après le traité ?', 'L\'année suivante', ['Immédiatement', 'Le mois suivant', 'Jamais'])!,
                buildMCQ('stories', 'Quelle épouse du Prophète ﷺ l\'a conseillé après le traité ?', 'Umm Salama', ['Aisha', 'Khadija', 'Hafsa'])!,
            ],
            unlocked: false, completed: false, stars: 0,
        },
        {
            ...
            titleAr: 'فتح مكة',
            description: 'La conquête de la Mecque sans effusion de sang.',
            location: 'Makkah',
            year: '630 ap. J-C (8 AH)',
            questions: [
                buildMCQ('stories', 'Pourquoi les musulmans ont-ils marché sur la Mecque ?', 'Quraysh a rompu le traité', ['Pour se venger', 'Pour s\'enrichir', 'Pour détruire la ville'])!,
                buildMCQ('stories', 'Combien de musulmans composaient l\'armée de la conquête ?', '10 000', ['3 000', '1 000', '30 000'])!,
                buildMCQ('stories', 'Quel chef de Quraysh a embrassé l\'Islam juste avant la conquête ?', 'Abu Sufyan', ['Abu Jahl', 'Abu Lahab', 'Walid ibn Mughira'])!,
                buildMCQ('stories', 'Qu\'a fait le Prophète ﷺ aux idoles autour de la Kaaba ?', 'Il les a détruites', ['Il les a déplacées', 'Il les a vendues', 'Il les a ignorées'])!,
                buildMCQ('stories', 'Quelle parole célèbre le Prophète ﷺ a-t-il dite aux mecquois ?', 'Allez-vous en, vous êtes libres', ['Vous serez tous punis', 'Payez une rançon', 'Convertissez-vous ou mourrez'])!,
                buildMCQ('stories', 'Qui a fait l\'Azan (appel à la prière) sur le toit de la Kaaba ?', 'Bilal ibn Rabah', ['Abu Bakr', 'Ali', 'Zaid'])!,
                buildMCQ('stories', 'En quel mois a eu lieu la conquête de la Mecque ?', 'Ramadan', ['Dhul-Hijja', 'Muharram', 'Rajab'])!,
                buildMCQ('stories', 'Quelle sourate courte célèbre a été révélée à ce sujet ?', 'Al-Nasr', ['Al-Ikhlas', 'Al-Falaq', 'Al-Fil'])!,
                buildMCQ('stories', 'Qui a porté la bannière du Prophète ﷺ lors de l\'entrée à la Mecque ?', 'Sa\'d ibn Ubadah puis son fils', ['Omar', 'Khalid', 'Uthman'])!,
